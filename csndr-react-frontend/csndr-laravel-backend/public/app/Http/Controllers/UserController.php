...
class UserController extends Controller
{
    ...
    {
        try {
            $users = User::select('id','nom','prenom','email','role','classe_id','parent_id','created_at','updated_at')->get();
    ...
    public function store(Request $request)
    {
        try {
            ...
            return response()->json($user->only(['id','nom','prenom','email','role','classe_id','parent_id','created_at','updated_at']), 201);
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return response()->json($user->only(['id','nom','prenom','email','role','classe_id','parent_id','created_at','updated_at']));
